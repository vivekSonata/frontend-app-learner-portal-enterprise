...
import {
  ...
  FEATURE_ENABLE_AI_LEARNER_PATHWAYS,
} from './constants';
...
export const features = {
  ...
  NEW_CONTENT_FACET: process.env.FEATURE_NEW_CONTENT_FACET || hasFeatureFlagEnabled(FEATURE_NEW_CONTENT_FACET),
  ...
  FEATURE_ENABLE_AI_LEARNER_PATHWAYS: process.env.FEATURE_ENABLE_AI_LEARNER_PATHWAYS
    || hasFeatureFlagEnabled(FEATURE_ENABLE_AI_LEARNER_PATHWAYS),
};
